...
class AccountService {
    async createAccount(input) {
        ...
        const account = await repository_1.prisma.account.create({
            data: {
                ...
                balance: new prisma_1.Prisma.Decimal(0),
                encryptedName,
                encryptedEmail,
            },
        });
    ...
    async updateBalance(id, amount, type) {
        ...
        const decimalAmount = new prisma_1.Prisma.Decimal(amount);
        if (decimalAmount.lte(new prisma_1.Prisma.Decimal(0))) {
      ...
      `;
            ...
            const currentBalance = new prisma_1.Prisma.Decimal(account.balance.toString());
            let newBalance;
            if (type === 'DEBIT') {
